...
//
//     final getIndentsDetails = getIndentsDetailsFromJson(jsonString);

import 'dart:convert';

GetIndentsDetails getIndentsDetailsFromJson(String str) => GetIndentsDetails.fromJson(json.decode(str));

String getIndentsDetailsToJson(GetIndentsDetails data) => json.encode(data.toJson());

class GetIndentsDetails {
  String? id;
  String? code;
  SalesAgent? salesAgent;
  Location? productType;
  GetIndentsDetailsRetailer? retailer;
  DateTime? date;
  ...
  factory GetIndentsDetails.fromJson(Map<String, dynamic> json) => GetIndentsDetails(
        id: json["id"],
        code: json["code"],
        ...
        retailer: json["retailer"] == null ? null : GetIndentsDetailsRetailer.fromJson(json["retailer"]),
...
class GetIndentsDetailsRetailer {
  String? id;
  String? fullname;
  String? phone;
  Location? location;
  ...
  factory GetIndentsDetailsRetailer.fromJson(Map<String, dynamic> json) => GetIndentsDetailsRetailer(
        id: json["id"],
