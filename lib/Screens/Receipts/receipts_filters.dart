...
class ReceiptFiltersView extends StatefulWidget {
  const ReceiptFiltersView({Key? key}) : super(key: key);

  @override
  State<ReceiptFiltersView> createState() => _ReceiptFiltersView();
}

class _ReceiptFiltersView extends State<ReceiptFiltersView> {
  ...
  Widget build(BuildContext context) {
    return GetBuilder<ReceiptController>(
      initState: (_) => ReceiptController.to.initFilterState(),
